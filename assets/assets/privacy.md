...
- Indirizzo e-mail, utilizzato come identificativo per l'accesso (login) all'Applicativo;
- Ore lavorate e attività svolte, inserite dall'utente per la rendicontazione del lavoro prestato;
- Data dell'ultimo accesso (ultimo login), campo tecnico che viene sovrascritto a ogni nuovo accesso e non conserva uno storico degli accessi precedenti.
...
|---|---|
| Autenticazione e gestione dell'account utente | Esecuzione del rapporto associativo/di lavoro (art. 6.1.b) e legittimo interesse alla sicurezza del sistema (art. 6.1.f) |
...
Supabase Inc. è una società con sede negli Stati Uniti che agisce quale sub-responsabile del trattamento (subfornitore) per conto dello sviluppatore/Responsabile del trattamento. Sebbene i dati siano fisicamente conservati in un data center europeo, *l'accesso da parte del personale di Supabase per finalità di supporto tecnico potrebbe, in via residuale, comportare un trattamento extra-UE*. Si raccomanda alla Cooperativa di verificare che Supabase abbia sottoscritto le Clausole Contrattuali Standard (SCC) della Commissione Europea o altro strumento di trasferimento adeguato ai sensi del Capo V del GDPR, e di richiederne copia per la propria documentazione (accountability).
...
- al Responsabile del trattamento (sviluppatore/gestore tecnico dell'Applicativo) e al sub-responsabile Supabase Inc., per le finalità tecniche di erogazione del servizio;
...
- ottenere conferma dell'esistenza di un trattamento e accedere ai tuoi dati personali (art. 15 GDPR);
...
- ricevere in formato strutturato i dati che ti riguardano, ove tecnicamente fattibile (portabilità, art. 20 GDPR);
